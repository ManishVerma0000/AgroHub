...
export function WarehouseForm({ initialData, onSave, onCancel }: WarehouseFormProps) {
  ...
  React.useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        overheadCost: initialData.overheadCost !== undefined && initialData.overheadCost !== null ? initialData.overheadCost.toString() : '0',
        logisticCost: initialData.logisticCost !== undefined && initialData.logisticCost !== null ? initialData.logisticCost.toString() : '0',
      });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({
      ...
      logisticCost: Number(formData.logisticCost),
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      {/* SECTION: Handling Cost */}
      <div className="bg-white rounded-xl border border-[#f3f4f6] p-6 shadow-sm">
        <h2 className="text-lg font-bold text-[#111827] mb-6">Handling Cost</h2>
