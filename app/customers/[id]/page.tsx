        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-4">
               <div className="w-[60px] h-[60px] rounded-full bg-[#16a34a] text-white flex items-center justify-center font-bold text-[24px] shadow-sm">
                 {initials}
               </div>
            ...
            <div className="flex items-center gap-3">
               {customer.mobileNumber && (
                 <a 
                   ...
                   className="px-6 py-2 bg-[#25D366] hover:bg-[#20ba5a] text-white text-[14px] font-bold rounded-lg transition-all shadow-md shadow-[#25D366]/10 flex items-center gap-2"
                 >
